...
> You can replace these with Try on Clothes Premium–specific examples later to further distinguish from the Pro documentation.

---

## Pricing & Credits

Each successful **Try on Clothes Premium** API call consumes a fixed number of credits.

### Credits per API Call

| API                    | Credits per Call |
|:-----------------------|:-----------------|
| Try on Clothes Premium | 50               |

---

### Universal Credit Packages (All APIs)

Universal credit packages can be used across all AILabTools APIs, including **Try on Clothes Premium**.

|   Amount |   Credits | Price / Credit | Approx. Premium Calls (50 credits/call) | Cost / Premium Call |
|---------:|----------:|---------------:|-----------------------------------------:|---------------------:|
...
If you require more credits or custom terms, please contact us at  
<a href="mailto:business@ailabtools.com">business@ailabtools.com</a>.
</Tip>
...
<Tip>
- **Uploaded Files**: Not stored. Used only for processing the current request.  
- **Generated Files**:  
  - **Retention**: Stored for up to 24 hours to support download and integration.  
