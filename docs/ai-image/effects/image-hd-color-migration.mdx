...
description: "Color topping of HD images and the ability to ensure that the color of the portrait portion does not change. This interface compares with [Color Migration](ai-image/effects/image-color-migration)."
---
