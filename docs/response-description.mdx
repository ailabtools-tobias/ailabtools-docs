...
| 400 | `ERROR_PARAMETERS` | Parameter error. |
...
| 500 | `SERVICE_INTERNAL_ERROR` | There is an internal error in the service, please try again later. If it is not resolved in time, please contact the platform. |
