...
|:------------|:--------------------------------------------|:----------------------------------------------------------------------------------------------------------------|
| 400         | `ERROR_BAD_REQUEST`                         | Bad request.                                                                                                    |
...
| 401         | `ERROR_UNAUTHORIZED`                        | Authentication is required.                                                                                     |
| 402         | `ERROR_PAYMENT_REQUIRED`                    | Payment is required.                                                                                            |
| 403         | `ERROR_FORBIDDEN`                           | Access is forbidden.                                                                                            |
| 403         | `ERROR_ILLEGAL_OPERATION`                   | Illegal operation.                                                                                              |
| 403         | `ERROR_FACE_TRACE_LIMIT_EXCEEDED`           | Face or Trace limit exceeded.                                                                                   |
| 403         | `ERROR_DATABASE_LIMIT_EXCEEDED`             | Database limit exceeded.                                                                                        |
| 403         | `EXCEEDING_LIMITS`                          | Exceeds limit.                                                                                                  |
...
| 404         | `ERROR_USER_NOT_EXISTS`                     | The user does not exist.                                                                                        |
| 404         | `ERROR_APPLICATIONS_NOT_EXISTS`             | The application does not exist.                                                                                 |
| 404         | `ERROR_AI_NOT_EXISTS`                       | AI does not exist or has been deactivated, please contact the platform.                                         |
| 405         | `ERROR_METHOD_NOT_ALLOWED`                  | The request method is not allowed.                                                                              |
| 406         | `ERROR_NOT_ACCEPTABLE`                      | The server cannot produce a response matching the request requirements.                                         |
| 406         | `ERROR_INVALID_RESPONSE_FORMAT`             | Incorrect response format (Accept not supported).                                                               |
| 407         | `ERROR_PROXY_AUTHENTICATION_REQUIRED`       | Proxy authentication is required.                                                                               |
| 408         | `ERROR_REQUEST_TIMEOUT`                     | Request timed out.                                                                                              |
| 409         | `ERROR_CONFLICT`                            | The request conflicts with the current state of the resource.                                                   |
...
| 409         | `ERROR_CLEANING_USER_GROUP_DATA`            | Cleaning user group data.                                                                                       |
| 409         | `ERROR_RESOURCE_IN_TRANSIT`                 | Resource in transit.                                                                                            |
| 410         | `ERROR_GONE`                                | The requested resource is no longer available.                                                                  |
| 410         | `ERROR_TASK_REVOKED`                        | Task has already been revoked.                                                                                  |
| 410         | `ERROR_RESOURCE_RECLAIMED`                  | Resource has been reclaimed.                                                                                    |
| 411         | `ERROR_LENGTH_REQUIRED`                     | The request requires a Content-Length header.                                                                   |
| 412         | `ERROR_PRECONDITION_FAILED`                 | The request precondition was not met.                                                                           |
| 413         | `ERROR_REQUEST_BODY_TOO_LARGE`              | Request body size exceeds limit.                                                                                |
| 413         | `FILE_SIZE_EXCEEDS_LIMIT`                   | File size exceeds limit.                                                                                        |
| 414         | `ERROR_URI_TOO_LONG`                        | The request URI is too long.                                                                                    |
| 415         | `ERROR_UNSUPPORTED_MEDIA_TYPE`              | Unsupported media type.                                                                                         |
| 415         | `UNSUPPORTED_FILE_TYPES`                    | Unsupported file types.                                                                                         |
| 416         | `ERROR_RANGE_NOT_SATISFIABLE`               | The requested range cannot be satisfied.                                                                        |
| 417         | `ERROR_EXPECTATION_FAILED`                  | The request expectation cannot be met.                                                                          |
| 418         | `ERROR_I_AM_A_TEAPOT`                       | The server cannot process this request.                                                                         |
| 421         | `ERROR_MISDIRECTED_REQUEST`                 | The request was directed to a server that cannot produce a response.                                            |
| 422         | `ERROR_UNPROCESSABLE_ENTITY`                | The request is well-formed but its content cannot be processed.                                                 |
| 422         | `ERROR_INVALID_PARAMETER`                   | Invalid parameter.                                                                                              |
| 422         | `ERROR_INVALID_SIDE_PARAMETER`              | Invalid value for Side parameter.                                                                               |
| 422         | `ERROR_UNSUPPORTED_RESPONSE_FORMAT`         | Incorrect response format (Format not supported).                                                               |
| 422         | `ERROR_INVALID_OUTPUT_FORMAT`               | Invalid output format.                                                                                          |
...
| 422         | `ERROR_TOO_MANY_GROUPS_IN_GROUP_LIST`       | Too many groups in group_list.                                                                                  |
| 422         | `ERROR_TOO_MANY_UIDS_IN_UID_LIST`           | Too many UIDs in uid_list.                                                                                      |
| 422         | `ERROR_TOO_MANY_APPS_IN_APP_LIST`           | Too many apps in app_list.                                                                                      |
| 422         | `ERROR_TOO_MANY_FILES`                      | Number of files exceeds the limit.                                                                              |
| 422         | `FILE_RESOLUTION_EXCEEDS_LIMITS`            | File resolution exceeds limits.                                                                                 |
| 422         | `ERROR_HIGH_RESOLUTION`                     | File resolution too high.                                                                                       |
| 422         | `ERROR_UNSUPPORTED_GRAYSCALE_IMAGE`         | Grayscale image not supported.                                                                                  |
...
| 422         | `ERROR_INPUT_CONTENT_NON_COMPLIANCE`        | The input content did not pass the content safety check.                                                        |
| 422         | `ERROR_OUTPUT_CONTENT_NON_COMPLIANCE`       | The output content did not pass the content safety check.                                                       |
...
| 423         | `ERROR_LOCKED`                              | The requested resource is locked.                                                                               |
| 423         | `ERROR_USER_LOCKED`                         | The user is locked.                                                                                             |
| 424         | `ERROR_FAILED_DEPENDENCY`                   | The request failed because a dependent operation failed.                                                        |
| 425         | `ERROR_TOO_EARLY`                           | The request is too early and may be replayed.                                                                   |
| 426         | `ERROR_UPGRADE_REQUIRED`                    | A protocol upgrade is required.                                                                                 |
| 428         | `ERROR_PRECONDITION_REQUIRED`               | The request must include the required preconditions.                                                            |
| 429         | `ERROR_TOO_MANY_REQUESTS`                   | Too many requests. Please try again later.                                                                      |
...
| 431         | `ERROR_REQUEST_HEADER_FIELDS_TOO_LARGE`     | Request header fields are too large.                                                                            |
| 451         | `ERROR_UNAVAILABLE_FOR_LEGAL_REASONS`       | The requested resource is unavailable for legal reasons.                                                        |
| 500         | `ERROR_INTERNAL_SERVER_ERROR`               | Internal server error. Please try again later. If not resolved promptly, contact the platform.                  |
...
| 501         | `ERROR_NOT_IMPLEMENTED`                     | The server has not implemented the requested functionality.                                                     |
| 501         | `ERROR_IMAGE_STORAGE_NOT_SUPPORTED`         | Image storage not supported.                                                                                    |
| 502         | `ERROR_BAD_GATEWAY`                         | Bad gateway. Please try again later. If not resolved promptly, contact the platform.                            |
| 502         | `AI_SERVICE_ERROR`                          | AI service error. Please try again later. If not resolved promptly, contact the platform.                       |
| 502         | `PROCESSING_FAILURE`                        | Processing failure.                                                                                             |
...
| 503         | `ERROR_SERVICE_UNAVAILABLE`                 | The service is temporarily unavailable. Please try again later. If not resolved promptly, contact the platform. |
...
| 504         | `ERROR_GATEWAY_TIMEOUT`                     | Gateway timeout. Please try again later. If not resolved promptly, contact the platform.                        |
...
| 505         | `ERROR_HTTP_VERSION_NOT_SUPPORTED`          | HTTP version is not supported.                                                                                  |
| 506         | `ERROR_VARIANT_ALSO_NEGOTIATES`             | The server has a content-negotiation configuration error.                                                       |
| 507         | `ERROR_INSUFFICIENT_STORAGE`                | The server has insufficient storage to complete the request.                                                    |
| 508         | `ERROR_LOOP_DETECTED`                       | The server detected an infinite loop while processing the request.                                              |
| 509         | `ERROR_BANDWIDTH_LIMIT_EXCEEDED`            | The server bandwidth limit has been exceeded.                                                                   |
| 510         | `ERROR_NOT_EXTENDED`                        | Further extensions are required to fulfill the request.                                                         |
| 511         | `ERROR_NETWORK_AUTHENTICATION_REQUIRED`     | Network authentication is required.                                                                             |
