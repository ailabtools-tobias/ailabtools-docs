...
<Tabs>
  ...
  <Tab title="AI PORTRAIT">
    <table>
      ...
      <tbody>
      <QueryingCreditsTableRow rowSpan={22} category="Portrait Effects" href="/docs/ai-portrait/effects/portrait-animation" apiName="Cartoon Yourself" sign="portrait_cartoonization" />
      ...
      <QueryingCreditsTableRow rowSpan={14} category="Portrait Editing" href="/docs/ai-portrait/editing/try-on-clothes" apiName="Try on Clothes" sign="portrait_try_on_clothes" />
  ...
  <Tab title="AI IMAGE">
    <table>
      ...
      <QueryingCreditsTableRow rowSpan={11} category="Image Editing" href="/docs/ai-image/editing/image-cropping" apiName="AI Image Cropping" sign="image_cropping" />
