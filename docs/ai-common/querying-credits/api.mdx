...
<Tabs>
  ...
  <Tab title="AI PORTRAIT">
    <table>
      ...
      <tbody>
      <QueryingCreditsTableRow rowSpan={18} category="Portrait Effects" href="/docs/ai-portrait/effects/portrait-animation" apiName="Cartoon Yourself" sign="portrait_cartoonization" />
