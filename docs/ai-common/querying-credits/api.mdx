...
<Tabs>
  ...
  <Tab title="AI PORTRAIT">
    <table>
      ...
      <QueryingCreditsTableRow rowSpan={9} category="Portrait Editing" href="/docs/ai-portrait/editing/ai-breast-expansion" apiName="AI Breast Expansion" sign="portrait_ai_big_tits" />
